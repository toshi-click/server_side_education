...
- リポジトリ内に`config/kadai/step2_2`フォルダを作成してください
- このステップで作成した手順は上記フォルダ内に格納してください
...
- リポジトリ内に`config/kadai/step2_3`フォルダを作成してください
- このステップで作成した手順は上記フォルダ内に格納してください
...
#### 2-4 PHPのインストール
- リポジトリ内に`config/kadai/step2_4`フォルダを作成してください
- このステップで作成した手順は上記フォルダ内に格納してください
